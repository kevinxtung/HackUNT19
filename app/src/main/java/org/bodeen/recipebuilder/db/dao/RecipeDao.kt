...
interface RecipeDao {
    ...
    @Query(
        "SELECT ingredient_table.*, amount FROM ingredient_table, recipe_ingredient_table " +
    ...
    @Query(
        "SELECT nutrient_table.*, amount FROM nutrient_table, ingredient_nutrient_table " +
